 ...
 !function(t, n) {
  ...
  var s = function() {
      ...
      return i(t, [{
          ...
          value: function(t) {
              ...
              this._shouldTick(n) ? (this.emit("tick", this.next),
  ...
  return function() {
      function i(t) {
          ...
          this.scrollEventContainer.addEventListener("keydown", this.onInteractStart, a && {
              passive: !0
          }),
      ...
      (u = [{
          ...
          value: function() {
              this.stopAnimation(),
              this.disable(),
              this.scrollEventContainer.removeEventListener("keydown", this.onInteractStart, a && {
                  passive: !0
              }),
          ...
          value: function() {
              ...
              this.isInteracting || this.animation || (this.scrollTimeout = setTimeout(this.findSnapTarget.bind(this), 50 + this.options.delay))
          }
      }, {
          key: "findSnapTarget",
          value: function() {
              ...
              if (o.length > 1) {
                  if (Math.abs(t) < this.options.directionThreshold && Math.abs(n) < this.options.directionThreshold && this.activePanel)
                  ...
                  }(this.container, l) ? (console.error("PanelSnap does not support space between panels, snapping back."),
                  this.snapToPanel(l, t > 0, n > 0)) : this.activatePanel(l)
              }
          }
      }, {
          key: "snapToPanel",
          value: function(t) {
              ...
              this.isEnabled && (this.animation && this.animation.stop(),
          ...
          key: "activatePanel",
          value: function(t) {
              this.activePanel !== t && (this.emit("activatePanel", t),
              this.activePanel = t)
          }
      }]) && t(h.prototype, u),
      f && t(h, f),
